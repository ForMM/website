	...
	<div>
		<div class="container content">
			...
			<div class="slogan">
				 一个决定，一份执着，一种苛求
				<br>
				把细心融入设计，把专业融入项目，把热情投入行业
			</div>
			<div class="company-intro">
				<span>也娜环保科技有限公司</span>
				<br/>				
			...
			<div class="company-intro">
				<span>服务范围</span>
				<br/>				
				公司成立于2009年3月24日，是一家专业从事双组份瓷缝剂、双组份美缝剂、双组晶体晶体瓷流平、等系列产品研发、生产制造、销售于一体的公司。是建材装饰用品中的一头领头羊，以对于细节和品质近乎痴迷的追求，通过精选材料、深化设计、高品质服务，摆脱了同行的低价竞争。公司拥有一支强大的技术研发队伍与以诚信为本的行为理念共同成就了也娜在众多同行中无法撼动的地位。遥遥领先的市场占有率获得市场和同行的双重认可和尊重！
			</div>
			<div class="company-intro">
				<span>发展目标</span>
				<br/>				
				一步一个脚印，使企业能更好的适应市场的变化，避免发展中的大起大落，实现企业可持续健康发展。以“为员工创造平台，为客户创造价值，为城市创造美丽，为社会创造财富”为使命成就专业让员工成为专业行家，让公司成为行业专家！
			</div>
			<div class="company-intro">
				<span>企业理念</span>
				<br/>				
				“真诚、善意、精致、完美”的核心价值观！
以“为员工创造平台，为客户创造价值，为城市创造美丽，为社会创造财富！
使命成就专业让员工成为专业行家，让公司成为行业专家！
			</div>
		</div>		
	</div>
